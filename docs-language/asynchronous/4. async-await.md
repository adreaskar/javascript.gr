...
-   Εύκολος χειρισμός σφαλμάτων με την χρήση του `try/catch`.
-   Αποφυγή Callback Hell.
...
| `async/await` | Καθαρός και γραμμικός κώδικας, χρήση try/catch    | Απαιτεί κατανόηση των Promises και ES2017+ περιβάλλον |
